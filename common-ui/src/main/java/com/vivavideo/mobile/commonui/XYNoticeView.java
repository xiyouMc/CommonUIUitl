...
public class XYNoticeView extends TextSwitcher {
    ...
    public XYNoticeView(Context context) {
        this(context, null);
    }

    public XYNoticeView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void initWithContext(Context context, AttributeSet attrs) {
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.XYNoticeView);
        mIcon = a.getDrawable(R.styleable.XYNoticeView_nvIcon);
        mIconPadding = (int)a.getDimension(R.styleable.XYNoticeView_nvIconPadding, 0);

        boolean hasIconTint = a.hasValue(R.styleable.XYNoticeView_nvIconTint);

        if (hasIconTint) {
            mIconTint = a.getColor(R.styleable.XYNoticeView_nvIconTint, 0xff999999);
        }

        mInterval = a.getInteger(R.styleable.XYNoticeView_nvInterval, 4000);
        mDuration = a.getInteger(R.styleable.XYNoticeView_nvDuration, 900);
    ...
    class TextFactory implements ViewFactory {
        ...
        void resolve(TypedArray ta) {
            lines = ta.getInteger(R.styleable.XYNoticeView_nvTextMaxLines, lines);
            size = ta.getDimension(R.styleable.XYNoticeView_nvTextSize, size);
            color = ta.getColor(R.styleable.XYNoticeView_nvTextColor, color);
            gravity = ta.getInteger(R.styleable.XYNoticeView_nvTextGravity, gravity);
        }
